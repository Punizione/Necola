...
typedef std::uint16_t MDLHandle_t;
...
public:
	inline const char * GetModelNameInternalOffset(MDLHandle_t handle) {
		return reinterpret_cast<const char *(__thiscall*)(void*, MDLHandle_t)>(U::Offsets.m_dwGetModelName)(this, handle);
	}
};
